...
set_target_properties(lapacke PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liblapacke.3.10.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liblapacke.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS lapacke )
list(APPEND _IMPORT_CHECK_FILES_FOR_lapacke "${_IMPORT_PREFIX}/lib/liblapacke.3.10.0.dylib" )
